...
*See `sell_marketing_promoted_listings_overview.md`, `sell_marketing_campaign_flows.md`, and `sell_analytics_traffic_and_reports.md` for a full overview and integration guides on Promoted Listings (General, Priority, and Offsite).*
...
*See `commerce_taxonomy_api.md` for a full overview and integration guides.*

- **Get Default Category Tree**: `GET /commerce/taxonomy/v1/get_default_category_tree_id`
