...
description: Builds elaborate, multi-component web artifacts using React, Tailwind CSS, and shadcn/ui. Use when the user needs complex artifacts with state management, routing, or shadcn/ui components.
---
